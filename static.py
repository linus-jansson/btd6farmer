button_positions = { # Creates a dictionary of all positions needed for monkeys (positions mapped to 2160 x 1440 resolution)
    ...
    "SELECT_OBYN" : [106, 532],
    "SELECT_GERALDO" : [306, 532],
    "SELECT_CAPTAIN_CHURCHILL" : [506, 532],
    "SELECT_STRIKER_JONES" : [506, 232],
    "SELECT_GWENDOLIN" : [306, 232],
    "SELECT_QUINCY" : [106, 232],
    "SELECT_PAT_FUSTY" : [506, 832],
    "SELECT_EZILI" : [306, 832],
    "SELECT_BENJAMIN" : [106, 832],
    "SELECT_ETIENNE" : [506, 1132],
    "SELECT_ADMIRAL_BRICKELL" : [306, 1132],
    "SELECT_ADORA" : [106, 1132],
    "SELECT_SAUDA" : [106, 1332],
    "SELECT_PSI" : [306, 1332],
